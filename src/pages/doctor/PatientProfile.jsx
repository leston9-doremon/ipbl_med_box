...
import { User, Activity, ShieldAlert, Cpu, Heart, CheckCircle2, FileText } from 'lucide-react';
    ...
    <div className="grid md:grid-cols-3 gap-6">
      ...
      <div className={`p-6 rounded-medical border shadow-sm md:col-span-1 flex flex-col items-center justify-between text-center
        ...
        <div className="w-full border-t border-slate-100 dark:border-slate-800 pt-4 mt-6 flex justify-between items-center text-xs">
          <span className="text-slate-400">Box Signal</span>
      ...
      <div className={`p-6 rounded-medical border shadow-sm md:col-span-2 flex flex-col justify-between
        ...
        <div>
          <div className="border-b border-slate-100 dark:border-slate-800 pb-4 mb-6">
            <h2 className="text-base font-extrabold text-slate-850 dark:text-white">EMR Medical History</h2>
            <p className="text-xs text-slate-455 mt-0.5">Clinical metrics logged in the hospital directory</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-xs">
            ...
            <div className="p-3.5 rounded-xl border border-rose-250 bg-rose-500/5 dark:border-rose-900/30">
              ...
              <span className="font-semibold text-slate-750 dark:text-slate-350 block mt-1.5">
                {patient.condition}
              </span>
            </div>
            ...
            <div className={`p-3.5 rounded-xl border flex items-center justify-between
              ...
              <div className="flex items-center space-x-2 text-slate-500">
                ...
                <span className="font-semibold text-slate-655 dark:text-slate-350">Blood Group</span>
              </div>
            ...
            <div className={`p-3.5 rounded-xl border md:col-span-2 flex items-center justify-between
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-700 dark:text-slate-350">Smart Box Hardware ID</span>
                  <span className="text-[10px] text-slate-405 dark:text-slate-550">IOT registration code</span>
                </div>
              </div>
            ...
            <div className={`p-3.5 rounded-xl border md:col-span-2 flex items-center justify-between
              ...
              <div className="flex items-center space-x-2.5">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-slate-700 dark:text-slate-350">Primary Health Guardian</span>
                  <span className="text-[10px] text-slate-405 dark:text-slate-555">Authorized caregiver relationship</span>
                </div>
              </div>
              <span className="font-bold text-slate-750 dark:text-slate-300 text-xs">{patient.guardianName}</span>
            </div>
          </div>
        </div>

        <span className="text-[9px] text-slate-400 uppercase font-semibold text-center border-t border-slate-105 dark:border-slate-800 pt-4 mt-6 flex items-center justify-center space-x-1">
          <FileText size={12} className="text-primary shrink-0" />
          <span>Patient record locked and verified in compliance with healthcare data protocols.</span>
        </span>
      </div>
