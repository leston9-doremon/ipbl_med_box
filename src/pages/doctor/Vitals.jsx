      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
            ...
            <span className="font-bold text-slate-650 dark:text-slate-355">60 - 100 BPM</span>
          </div>
        </div>
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
            <span className="text-slate-400">Normal Range</span>
            <span className="font-bold text-slate-650 dark:text-slate-355">36.1 - 37.2 °C</span>
          </div>
        </div>
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ${darkMode ? 'bg-slate-900/60 border-slate-800' : 'bg-white border-slate-200'}`}>
          <div className="flex justify-between items-start">
            <span className="text-[10px] text-slate-405 font-bold uppercase tracking-wider">ECG Status</span>
          ...
          <div className="flex items-center space-x-4 py-4">
            ...
            <div className="min-w-0">
              ...
              <span className="text-[9px] text-slate-450 dark:text-slate-550 block">Continuous Analysis</span>
            </div>
          </div>
          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider">
              Lead II Waveform Monitor
            </h3>
            <p className="text-[10px] text-slate-400 mt-0.5">Continuous telemetry feed sync'd via patient contact nodes</p>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className={`p-5 rounded-medical border shadow-sm
          ...
          <h3 className="text-xs font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider mb-4">
            Patient Pulse History (BPM Trend)
          </h3>
        ...
        <div className={`p-5 rounded-medical border shadow-sm
          ${darkMode ? 'bg-slate-900/60 border-slate-800' : 'bg-white border-slate-200'}`}>
          <h3 className="text-xs font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider mb-4">
            Patient Body Temperature History (Celsius Trend)
          </h3>
          <div className="h-64 relative">
