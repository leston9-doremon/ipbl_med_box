        ...
        <div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-xs text-slate-450 dark:text-slate-400 mt-0.5">Official orders uploaded by care team</p>
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-60 pl-9 pr-4 py-1.5 text-xs rounded-xl border outline-none transition-all
                  ${darkMode 
                    ? 'bg-slate-950 border-slate-800 text-slate-300 placeholder-slate-500 focus:border-primary/50' 
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800/40">
                {filteredRx.map((rx) => (
                  <tr key={rx.id} className="text-xs group hover:bg-slate-500/5 transition-colors">
                    {/* Title */}
                    ...
                    {/* Version */}
                    <td className="py-4 pr-2 text-slate-500">
                      <span className="bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold px-2 py-0.5 rounded">
                        {rx.version}
                      </span>
                    </td>
              ...
              <div>
                ...
                <div className={`mt-1.5 p-3 rounded-xl border flex items-center justify-between
                  ...
                  <div className="flex items-center space-x-2.5">
                    <FileSignature size={15} className="text-teal-500" />
