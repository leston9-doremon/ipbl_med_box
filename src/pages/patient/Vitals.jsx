...
export const Vitals = () => {
  ...
  // Temperature Trend Graph config
  const tempChartData = {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ...
          <div className="flex items-center space-x-4 py-4">
            <div className="h-12 w-12 rounded-xl bg-rose-500/10 text-rose-500 flex items-center justify-center pulse-animation shrink-0">
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
            <span className="text-slate-400 font-semibold">Normal Range</span>
            <span className="font-bold text-slate-600 dark:text-slate-300">60 - 100 BPM</span>
          </div>
        </div>
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
            <span className="text-slate-400 font-semibold">Normal Range</span>
            <span className="font-bold text-slate-600 dark:text-slate-300">36.1 - 37.2 °C</span>
          </div>
        </div>
        ...
        <div className={`p-6 rounded-medical border shadow-sm flex flex-col justify-between
          ...
          <div className="flex items-center space-x-4 py-4">
            <div className="h-12 w-12 rounded-xl bg-teal-500/10 text-teal-500 flex items-center justify-center shrink-0">
              <Activity size={24} />
            </div>
            <div>
              ...
              <span className="text-[10px] text-slate-400 font-semibold">Continuous Analysis</span>
            </div>
          </div>

          <div className="border-t border-slate-100 dark:border-slate-800 pt-3 flex justify-between items-center text-[10px]">
            <span className="text-slate-400 font-semibold">Health Status</span>
            <span className="font-extrabold text-emerald-500 uppercase tracking-wider bg-emerald-500/10 px-2 py-0.5 rounded-full">
      ...
      <div className={`p-6 rounded-medical border shadow-sm
        ...
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider">
              Electrocardiogram Lead II Waveform Monitor
            </h3>
            <p className="text-[10px] text-slate-400 mt-0.5">Continuous feed from box skin-contact sensors</p>
          </div>
        ...
        <ECGCanvas heartRate={telemetry.vitals.heartRate} height={160} />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className={`p-5 rounded-medical border shadow-sm
          ${darkMode ? 'bg-slate-900/60 border-slate-800' : 'bg-white border-slate-200'}`}>
          <h3 className="text-xs font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wider mb-4">
            Body Temperature History (Today)
          </h3>
          <div className="h-64 relative">
